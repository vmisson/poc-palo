  ...
  ip_configurations = [
    {
        ...
        subnet_id            = module.vnet["hub"].subnet_ids["gateway"]
    }
  ]
}

module "vpn_connection" {
  source       = "azurerm/resources/azure//modules/pattern_vpn_connection"
  location     = var.region
  gateway_1_id = module.standalone_site.gateway_id
  gateway_2_id = module.gateway.id
}